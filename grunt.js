...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    copy: {
      ...
      // Copy server/common files to client/common for build - cleaned after.
      
      common: {
        options: {
          basePath: 'src/server/common'
        },
        files: {
          "src/client/scripts/common/": [
            "src/server/common/**/*"
          ]
        }
      },
    ...
    clean: {
      build: "build/dev",
      release: "build/prod",
      common: "src/client/scripts/common"
    }
   ...
   * 3. Copies /src/server/common to /src/client/scripts/common for build
   * 4. Creates a development JS bundle using Browserify
   * 5. Cleans temp copy of common files in /src/client/scripts/common
   * 6. Compiles Stylus (.styl) files to CSS
   * 7. Lints the CSS that's been generated by 4
   * 8. Generates spritesheets
   * 9. Concatenates framework (vendor) JS files into a frameworks.js package
   * 10. Copies JS* and images from source directories into target dev build
   * 
